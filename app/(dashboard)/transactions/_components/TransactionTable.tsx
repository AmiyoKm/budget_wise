...
const emptyData : any = []
 const columns : ColumnDef<TransactionHistoryRow>[]= [{
    ...
    header : ({column})=> (
        <DataTableColumnHeader className='justify-center' column={column} title='Category' />
    ),
...

{
    accessorKey : "type",
    header : ({column})=> (
        <DataTableColumnHeader className='justify-center' column={column} title='Type' />
    ),
    filterFn : (row , id , value)=>{
        return value.includes(row.getValue(id))
    },
...

{
    accessorKey : "amount",
    header : ({column})=> (
        <DataTableColumnHeader className='justify-center' column={column} title='Amount' />
    ),
    cell : ({row})=>(
...
function RowActions({transaction} : {transaction : TransactionHistoryRow}){
    ...
    return(
        ...
        open={showDeleteDialog} setOpen={setShowDeleteDialog} transactionId={transaction.id} 
        />
        <DropdownMenu>
            <DropdownMenuTrigger>
