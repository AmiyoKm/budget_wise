...
const CreateCategoryDialog = ({type , successCallback , trigger}: {type :TransactionType , successCallback : (category:Category)=> void ,trigger? : ReactNode}  ) => {
    ...
    const mutation = useMutation({
        ...
        onSuccess : (data)=>{
            ...
            toast.success(`Category ${data.name} is created successfully 🎉` ,{
                id : "create-category"
            })
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          { trigger  ? trigger :  <Button variant={"ghost"} className='flex border-separate items-center justify-start rounded-none text-muted-foreground'>
                ...
                <FormField
                        ...
                        render={({field})=>(
                            <FormItem>
                                ...
                                <FormDescription >Transaction category (required)</FormDescription>
                            </FormItem>
                        )}
                        />
                         <FormField
                        ...
                        >
                          {form.watch("icon") ? (
                            ...
                            <div className="flex flex-1 flex-col items-center gap-2">
                                <CircleOff className="h-[48px] w-[48px] stroke-red-500" />
