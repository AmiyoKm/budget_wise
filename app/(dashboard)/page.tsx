    ...
    <div className='h-full bg-background'>
      <div className="border-b bg-card">
        <div className="max-w-full mx-6 flex flex-wrap items-center justify-between gap-6 py-8">
          <p className="text-3xl font-bold ">Hello, {user.firstName}! <span className='ml-6'>🐲</span></p>
          <div className='flex items-center gap-3'>
            <CreateTransactionDialog trigger={
              <Button variant={"outline"} className='border-emerald-500 bg-emerald-800 text-white hover:bg-emerald-600 hover:text-white'>
              New income 💵
              </Button>
